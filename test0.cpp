...
bool test0() {
  ...
  cout<<hashtable1.size()<<" is the size of default hashtable1."<<endl;
  cout<<hashtable2.size()<<" is the size of default hashtable2 (113 input)."<<endl;

  if (hashtable1.size() != 11) {
    cout<<hashtable1.size()<<" is the size of default hashtable."<<endl;
